...
![Distance measurement](distance-experementing/lora_field_test_satellite.png)
Here, we tested the radio coverage of the equipment

![Distance measurement](img/observatory_desk.jpg)
how we attatched the Feather board to at 69 angle to horizon to study the radio signal

![Balloon flight test animation](distance-experementing/balloon%20flight%20data/lora_balloon_flight.gif)
